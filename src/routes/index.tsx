...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] dark:bg-[#2b2b2b] text-[#111111] dark:text-slate-100 font-sans selection:bg-[#d2d0c1] selection:text-white transition-colors duration-300 overflow-x-hidden">
      {/* ========================================================================= */}
      {/* 12. NAVBAR SECTION */}
      {/* ========================================================================= */}
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
          isScrolled
            ? "bg-white/90 dark:bg-[#222222]/90 backdrop-blur-md shadow-md border-b border-border/40 py-3"
            ...
            <div>
              <span
                className={`font-serif italic text-2xl font-bold tracking-tight block leading-none ${
                  isScrolled ? "text-[#111111] dark:text-[#d2d0c1]" : "text-white"
                }`}
              >
                StockDine
              </span>
              <span
                className={`text-[9px] uppercase tracking-[0.25em] font-extrabold block mt-0.5 ${
                  isScrolled ? "text-[#d2d0c1] dark:text-slate-400" : "text-[#d2d0c1]"
                }`}
              >
            ...
            {isGuest ? (
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-2xl text-xs font-extrabold transition-all cursor-pointer border ${
                    isScrolled
                      ...
                      : "text-white bg-white/15 hover:bg-white/25 backdrop-blur-md border-white/30"
                  }`}
                >
                  Sign In
                </button>
                ...
                <button
                  ...
                  className="px-4.5 py-2.5 rounded-2xl bg-[#111111] hover:bg-[#333333] text-white text-xs font-extrabold uppercase tracking-wider shadow-md hover:shadow-lg transition-all active:scale-95 cursor-pointer flex items-center gap-2"
                >
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <Link
                  ...
                  className={`p-2.5 rounded-2xl transition-colors relative ${
                    isScrolled ? "hover:bg-[#F5F5F5] dark:hover:bg-[#383838] text-[#111111] dark:text-slate-200" : "hover:bg-white/20 text-white"
                  }`}
                  title="My Bookings"
                >
                ...
                <Link
                  to="/customer/profile"
                  className="flex items-center gap-2 px-3 py-1.5 rounded-2xl bg-[#111111]/10 dark:bg-[#383838] border border-[#111111]/20 text-[#111111] dark:text-slate-100 text-xs font-bold hover:border-[#111111] transition-all"
                >
                  <div className="size-6 rounded-full bg-[#111111] text-white flex items-center justify-center font-bold text-xs uppercase">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-slate-950 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(210,208,193,0.25),transparent_70%)] pointer-events-none z-0" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(17,17,17,0.5),transparent_60%)] pointer-events-none z-0" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto w-full text-center space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#d2d0c1]/15 border border-[#d2d0c1]/30 text-amber-300 text-xs font-extrabold tracking-wider uppercase sd-fade-up">
            <Sparkles className="size-3.5 text-[#d2d0c1]" />
            <span>Real-Time Dine-In Intelligence Platform</span>
          </div>

          {/* Headline */}
          <div className="space-y-4 sd-fade-up sd-delay-1">
            <h1 className="font-serif italic text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-[#d2d0c1] to-slate-200">
                Book What's Ready.
              </span>{" "}
          ...
          <div ref={searchRef} className="relative max-w-2xl mx-auto w-full space-y-3">
            <div className="p-2 sm:p-3 rounded-3xl bg-white/95 dark:bg-[#222222]/95 backdrop-blur-xl border border-[#E5E5E5] dark:border-[#404040] shadow-2xl flex flex-col sm:flex-row items-center gap-2 text-left">
              {/* Location Picker */}
              <div className="relative w-full sm:w-auto shrink-0">
                <button
                  type="button"
                  onClick={() => setShowLocationDropdown(!showLocationDropdown)}
                  className="w-full sm:w-auto flex items-center justify-between gap-2.5 px-4 py-2.5 rounded-2xl bg-[#F5F5F5] dark:bg-[#383838] text-xs font-extrabold text-[#111111] dark:text-slate-100 border border-[#E5E5E5] dark:border-[#404040] hover:border-[#111111] transition-all shadow-sm group"
                >
                  <div className="relative flex items-center justify-center">
                    <MapPin className="size-4 text-[#d2d0c1] group-hover:scale-110 transition-transform" />
                ...
                {showLocationDropdown && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-[#222222] rounded-2xl shadow-2xl border border-border dark:border-[#404040] p-2 z-50 animate-in fade-in zoom-in-95 duration-150">
                    {["Hyderabad", "Bengaluru", "Mumbai", "Chennai", "Delhi NCR"].map((loc) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded-xl text-xs font-bold transition-colors ${
                          selectedLocation === loc ? "bg-[#111111] text-white" : "hover:bg-[#F5F5F5] dark:hover:bg-[#383838] text-foreground"
                        }`}
                      >
                        {loc}
                      </button>
              ...
              <div className="relative flex-1 w-full flex items-center">
                <Search className="absolute left-3.5 size-4 text-[#333333]" />
                <input
                  type="text"
                  value={searchQuery}
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-transparent text-xs font-bold text-[#111111] dark:text-slate-100 placeholder:text-[#737373] focus:outline-none"
                />
                {isSearching && (
                  <div className="absolute right-3 size-4 border-2 border-[#d2d0c1] border-t-transparent rounded-full animate-spin" />
                )}
              </div>
              ...
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-2xl bg-[#111111] hover:bg-[#333333] text-white text-xs font-extrabold uppercase tracking-wider shadow-md transition-all active:scale-95 cursor-pointer shrink-0"
              >
                Search
              </button>
            </div>
            ...
            {/* ========================================================================= */}
            {showSearchDropdown && (
              <div className="absolute top-full left-0 right-0 mt-3 bg-white dark:bg-[#222222] rounded-3xl shadow-2xl border border-border/80 dark:border-[#404040] p-4 z-50 text-left space-y-4 max-h-[75vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
                {/* DISHES GROUP */}
                {searchResults.dishes && searchResults.dishes.length > 0 && (
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-widest text-[#d2d0c1]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {searchResults.dishes.map((dish) => (
                        <div
                          ...
                          className="p-2.5 rounded-2xl bg-secondary/10 hover:bg-[#d2d0c1]/10 border border-border/50 flex items-center justify-between gap-3 cursor-pointer transition-colors"
                        >
                          ...
                          <div className="text-right shrink-0">
                            <span className="text-xs font-extrabold text-[#d2d0c1] block">{formatCurrency(dish.price)}</span>
                ...
                {searchResults.restaurants && searchResults.restaurants.length > 0 && (
                  <div className="space-y-2 pt-2 border-t border-border/40">
                    <div className="flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-widest text-[#111111] dark:text-slate-300">
                    ...
                    <div className="space-y-1.5">
                      {searchResults.restaurants.map((rest) => (
                        <div
                          ...
                          className="p-2.5 rounded-2xl bg-secondary/10 hover:bg-[#d2d0c1]/10 border border-border/50 flex items-center justify-between cursor-pointer transition-colors"
                        >
                          <div className="flex items-center gap-3">
                            <img
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {searchResults.cuisines.map((cuis) => (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-secondary/20 hover:bg-[#d2d0c1] hover:text-white text-xs font-bold transition-colors cursor-pointer"
                        >
                          {cuis}
                        </button>
                      ))}
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <button
              ...
              className="px-8 py-4 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white font-extrabold text-xs uppercase tracking-wider shadow-xl hover:shadow-2xl transition-all active:scale-95 cursor-pointer flex items-center gap-2.5"
            >
      ...
      <ScrollReveal>
        <section id="available-dishes-section" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E5E5E5] pb-6">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#d2d0c1]/10 text-[#d2d0c1] text-[10px] font-extrabold uppercase tracking-widest border border-[#d2d0c1]/20 mb-2">
                <Flame className="size-3.5 fill-[#d2d0c1]" />
                <span>Real-Time Portion Counter</span>
              </div>
              <h2 className="font-serif italic text-3xl sm:text-4xl font-bold text-[#111111] dark:text-slate-100">
            ...
            <Link to="/customer" className="text-xs font-extrabold text-[#d2d0c1] hover:underline flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {filteredDishes.slice(0, 8).map((dish) => {
                ...
                return (
                  <div
                    key={dish._id}
                    className="group rounded-3xl bg-white dark:bg-[#222222] border border-[#E5E5E5] dark:border-[#404040] shadow-md sd-hover-lift overflow-hidden flex flex-col justify-between"
                  >
                    ...
                    <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                      <div className="space-y-1">
                        <div className="flex items-center justify-between gap-2">
                          <span className="text-[10px] font-extrabold uppercase text-[#d2d0c1] tracking-wider">
                        ...
                        <h3 className="font-serif italic text-lg font-bold text-foreground group-hover:text-[#d2d0c1] transition-colors">
                          {dish.dishName}
                        </h3>
                        <p className="text-xs text-muted-foreground font-medium flex items-center gap-1">
                          <Building2 className="size-3 text-[#d2d0c1]" />
                          <span>{restName}</span>
                        </p>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-[#E5E5E5]">
                        <div>
                          ...
                          <span className="text-base font-extrabold text-[#111111] dark:text-[#d2d0c1]">
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-xl bg-[#F5F5F5] hover:bg-[#111111] hover:text-white text-[#111111] dark:text-slate-100 text-xs font-extrabold transition-all active:scale-95 cursor-pointer"
                        >
                          View Dish →
                        </button>
                      </div>
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E5E5E5] pb-6">
            <div>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#111111]/10 text-[#111111] dark:text-[#d2d0c1] text-[10px] font-extrabold uppercase tracking-widest border border-[#111111]/20 mb-2">
                <Building2 className="size-3.5" />
          ...
          {loadingData ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-80 rounded-3xl bg-slate-200 dark:bg-[#383838] animate-pulse" />
              ))}
            </div>
            ...
            <div className="text-center py-12 bg-secondary/10 rounded-3xl p-8 space-y-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-2xl bg-[#d2d0c1] text-white text-xs font-extrabold"
              >
                Clear Filter
              </button>
            </div>
                ...
                >
                  <div>
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute bottom-3 left-3 px-3 py-1 rounded-xl bg-slate-950/80 backdrop-blur-md text-white text-[11px] font-extrabold flex items-center gap-1.5">
                        <Flame className="size-3 text-[#d2d0c1]" />
                    ...
                    <div className="p-6 space-y-3">
                      <div>
                        <h3 className="font-serif italic text-2xl font-bold text-foreground group-hover:text-[#d2d0c1] transition-colors">
                          {rest.restaurantName}
                        </h3>
                      ...
                      <div className="flex items-center justify-between text-xs font-bold pt-2 border-t border-[#E5E5E5]">
                  ...
                  <div className="p-6 pt-0">
                    <button
                      ...
                      className="w-full py-3.5 rounded-2xl bg-[#111111] hover:bg-[#333333] text-white text-xs font-extrabold uppercase tracking-wider shadow-md hover:shadow-lg transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2"
                    >
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#d2d0c1]/10 text-[#d2d0c1] text-[10px] font-extrabold uppercase tracking-widest border border-[#d2d0c1]/20">
              <Compass className="size-3.5" />
            ...
            {CUISINES_LIST.map((cuis) => {
              ...
              return (
                <div
                  ...
                  className={`group relative rounded-3xl border overflow-hidden transition-all duration-300 cursor-pointer flex flex-col justify-between h-56 sd-hover-lift ${
                    isSelected
                      ? "border-[#d2d0c1] ring-2 ring-[#d2d0c1] shadow-2xl scale-[1.02]"
                      : "border-[#E5E5E5] dark:border-[#404040] hover:border-[#d2d0c1]/60 hover:shadow-xl"
                  }`}
                >
                  ...
                  <img
                    src={cuis.image}
                    alt={cuis.name}
                    className="absolute inset-0 w-full h-full object-cover sd-image-zoom"
                  />
                  ...
                  <div className="relative z-10 p-4 flex justify-between items-start">
                    ...
                    {isSelected && (
                      <span className="size-6 rounded-full bg-[#d2d0c1] text-white flex items-center justify-center font-bold text-xs shadow-md">
                        ✓
                      </span>
                    )}
                  </div>
                  ...
                  <div className="relative z-10 p-5 space-y-1">
                    ...
                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#d2d0c1] block pt-1">
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="rounded-3xl bg-gradient-to-br from-[#111111] via-[#333333] to-slate-950 text-white p-8 sm:p-12 shadow-2xl space-y-8 relative overflow-hidden border border-white/10">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(210,208,193,0.2),transparent_60%)] pointer-events-none" />
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <span className="text-[10px] font-extrabold uppercase tracking-[0.25em] text-[#d2d0c1] bg-[#d2d0c1]/10 px-3.5 py-1.5 rounded-full border border-[#d2d0c1]/20">
              Product Features
            </span>
            <h2 className="font-serif italic text-3xl sm:text-5xl font-bold text-[#111111] dark:text-slate-100 pt-1">
              Why StockDine?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {WHY_STOCKDINE_FEATURES.map((feat) => {
              ...
              return (
                <div
                  key={feat.title}
                  className="p-8 rounded-3xl bg-white dark:bg-[#222222] border border-[#E5E5E5] dark:border-[#404040] shadow-md sd-hover-lift space-y-4 group"
                >
                  <div
                    className="size-14 rounded-2xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform"
                    style={{ backgroundColor: `${feat.color}15`, color: feat.color }}
                  >
                    <Icon className="size-7 stroke-[2]" />
                  </div>
                  <div className="space-y-2">
                    <h3 className="font-serif italic text-xl font-bold text-foreground group-hover:text-[#d2d0c1] transition-colors">
                      {feat.title}
                    </h3>
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            <span className="text-[10px] font-extrabold uppercase tracking-[0.25em] text-[#111111] dark:text-slate-300 bg-[#F5F5F5] dark:bg-[#383838] px-3.5 py-1.5 rounded-full">
              5 Simple Steps
            </span>
            <h2 className="font-serif italic text-3xl sm:text-5xl font-bold text-[#111111] dark:text-slate-100 pt-1">
              How StockDine Works
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {HOW_IT_WORKS_STEPS.map((s) => {
              ...
              return (
                <div
                  key={s.step}
                  className="p-6 rounded-3xl bg-white dark:bg-[#222222] border border-[#E5E5E5] dark:border-[#404040] shadow-md space-y-4 relative sd-hover-lift"
                >
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-2xl font-black text-[#d2d0c1]">{s.step}</span>
                    <div className="size-10 rounded-xl bg-[#F5F5F5] dark:bg-[#383838] text-[#111111] dark:text-[#d2d0c1] flex items-center justify-center">
          ...
          {reviews.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {reviews.map((rev) => (
                <div
                  key={rev._id}
                  className="p-6 rounded-3xl bg-white dark:bg-[#222222] border border-[#E5E5E5] dark:border-[#404040] shadow-md sd-hover-lift space-y-4 flex flex-col justify-between"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#d2d0c1]">
                        Verified Diner
                      </span>
                    </div>
      ...
      <ScrollReveal>
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="rounded-3xl bg-gradient-to-r from-[#111111] to-[#333333] text-white p-8 sm:p-14 shadow-2xl space-y-6 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(210,208,193,0.15),transparent_70%)] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                type="button"
                onClick={() => navigate({ to: "/customer" })}
                className="px-8 py-4 rounded-2xl bg-[#d2d0c1] text-white font-extrabold text-xs uppercase tracking-wider shadow-xl hover:bg-[#D66A38] transition-all active:scale-95 cursor-pointer flex items-center gap-2"
              >
                <span>Explore Restaurants</span>
                <ArrowRight className="size-4" />
              </button>
              ...
              <button
                ...
                className="px-8 py-4 rounded-2xl bg-white/10 hover:bg-white/20 text-white font-extrabold text-xs uppercase tracking-wider border border-white/30 backdrop-blur-md transition-all active:scale-95 cursor-pointer"
              >
                Get Started
              </button>
            </div>
      ...
      {/* FOOTER */}
      {/* ========================================================================= */}
      <footer className="bg-white dark:bg-[#2b2b2b] border-t border-[#E5E5E5] py-12 px-4 sm:px-6 lg:px-8 text-center text-xs text-muted-foreground space-y-4">
        <div className="flex items-center justify-center gap-3">
          <span className="font-serif italic text-xl font-bold text-[#111111] dark:text-slate-200">StockDine</span>
        </div>
