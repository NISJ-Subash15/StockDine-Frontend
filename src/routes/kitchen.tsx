...
function playKitchenOrderChime() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto selection:bg-[#d2d0c1] selection:text-white relative pb-28 transition-colors duration-300">
      {/* Header Bar */}
      ...
      <div className="mb-6 relative">
        ...
        {kitchenSearchQuery && (
          <button
            ...
            className="absolute right-4 top-3.5 text-xs font-bold text-[#737373] hover:text-[#111111]"
          >
            Clear
          </button>
        )}
      ...
      {/* Navigation Sub-Tabs */}
      <div className="flex gap-2 mb-6 border-b border-[#E5E5E5] pb-3 overflow-x-auto">
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeSubTab === "stock" && (
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-xl font-serif italic font-bold text-[#111111]">Touch-Friendly Stock Control</h2>
                  <p className="text-xs text-[#737373] font-medium">Adjust live portions instantly on customer and admin screens.</p>
                </div>
                ...
                <button
                  ...
                  className="py-2.5 px-4 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white text-xs font-extrabold shadow-md flex items-center gap-1.5 transition-all hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-4">
                {filteredDishes.length === 0 ? (
                  <div className="p-12 text-center bg-white dark:bg-[#222222] border-2 border-dashed border-border dark:border-[#404040] rounded-3xl space-y-4">
                  ...
                  <div
                    key={d.id}
                    className="bg-[#F5F5F5] border-2 border-[#E5E5E5] rounded-3xl p-5 shadow-sm space-y-4 hover-lift hover:border-[#d2d0c1]/50 transition-all"
                  >
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex items-start gap-3.5">
                        <img
                          src={d.image}
                          alt={d.name}
                          className="size-16 rounded-2xl object-cover shrink-0 border border-[#E5E5E5] shadow-sm"
                        />
                        <div>
                          <div className="flex items-center gap-2">
                            <h3 className="font-serif text-2xl font-bold text-[#111111]">{d.name}</h3>
                            <span
                              className={`text-[10px] font-extrabold uppercase px-2.5 py-0.5 rounded-full ${
                                d.stockType === "Available"
                                  ? "bg-emerald-500/10 text-emerald-700 border border-emerald-500/20"
                                  : d.stockType === "Fast Selling"
                                  ? "bg-[#d2d0c1]/15 text-[#111111] border border-[#d2d0c1]/30"
                      ...
                      <div className="text-right shrink-0">
                        <span className="font-serif text-5xl italic font-bold text-[#111111]">
                          {d.portionsLeft}
                        </span>
                        <p className="text-[9px] font-extrabold uppercase tracking-wider text-[#737373]">Portions Left</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-6 gap-2 pt-2 border-t border-[#E5E5E5]">
                      <button
                        type="button"
                        onClick={() => adjustStock(d.id, -10)}
                        className="py-3 rounded-2xl bg-[#FFFFFF] border-2 border-[#E5E5E5] text-[#111111] hover:bg-[#F5F5F5] text-xs font-extrabold transition-all active:scale-95"
                      >
                        -10
                      </button>
                      ...
                      <button
                        type="button"
                        onClick={() => adjustStock(d.id, 1)}
                        className="py-3 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white text-xs font-extrabold transition-all active:scale-95 shadow-sm"
                      >
                        +1
                      </button>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`flex-1 py-2.5 rounded-2xl text-xs font-extrabold transition-all ${
                          d.stockType === "Sold Out" ? "bg-[#d2d0c1] text-white shadow-sm" : "bg-[#111111] text-white shadow-sm"
                        }`}
                      >
                      ...
                      <button
                        ...
                        className="py-2.5 px-4 rounded-2xl bg-[#FFFFFF] border border-[#E5E5E5] hover:bg-[#F5F5F5] text-[#111111] text-xs font-bold transition-colors"
                      >
                        Edit Details
                      </button>
                    </div>
          ...
          {activeSubTab === "menu" && (
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-serif italic font-bold text-[#111111]">Today's Menu Items</h2>
                <button
                  type="button"
                  onClick={() => {
                    setEditingDishId(null);
                  ...
                  className="py-2.5 px-4 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white text-xs font-extrabold shadow-md flex items-center gap-1.5 transition-all hover:scale-105"
                >
                  <Plus className="size-4" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {filteredDishes.map((d) => (
                  <div
                    key={d.id}
                    className="bg-[#F5F5F5] border-2 border-[#E5E5E5] rounded-3xl p-4 shadow-sm flex gap-4 relative overflow-hidden hover-lift"
                  >
                    <img
                      src={d.image}
                      alt={d.name}
                      className="size-24 rounded-2xl object-cover shrink-0 border border-[#E5E5E5]"
                    />

                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start">
                          <h3 className="font-serif text-lg font-bold text-[#111111] truncate">{d.name}</h3>
                          <span className="text-[10px] font-extrabold uppercase px-2.5 py-0.5 rounded-full bg-[#111111]/10 text-[#111111]">
                            ₹{d.price}
                          </span>
                        </div>
                        <p className="text-xs text-[#737373] mt-0.5 line-clamp-1 font-medium">{d.description}</p>
                      </div>

                      <div className="flex items-center justify-between pt-2 border-t border-[#E5E5E5] mt-2">
                        <span className="text-xs font-bold text-[#111111]">Portions: {d.portionsLeft}</span>
                        <div className="flex gap-1">
                          <button
                            type="button"
                            onClick={() => handleEditDish(d)}
                            className="p-1.5 rounded-xl text-[#737373] hover:text-[#111111] hover:bg-white transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-xl text-[#737373] hover:text-[#111111] hover:bg-[#111111]/10 transition-colors"
                          >
          ...
          {activeSubTab === "orders" && (
            <div className="space-y-4">
              <h2 className="text-xl font-serif italic font-bold text-[#111111]">Incoming Order Tickets</h2>
              <div className="space-y-4">
                {activeOrders.map((b) => (
                  <div
                    key={b.bookingId}
                    className="bg-[#F5F5F5] border-2 border-[#E5E5E5] rounded-3xl p-5 shadow-sm space-y-4 hover-lift"
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <span className="text-[10px] font-mono font-bold bg-[#111111] text-white px-2.5 py-0.5 rounded-md shadow-sm">
                          {b.bookingId}
                        </span>
                        <h3 className="font-serif italic text-2xl font-bold text-[#111111] mt-1">{b.customerName}</h3>
                        <p className="text-xs text-[#737373] font-medium">
                          {b.tableNumber} • Arrival: {b.time}
                        </p>
                      </div>

                      <span className="text-xs font-extrabold uppercase px-3 py-1 rounded-full bg-[#333333]/10 text-[#333333] border border-[#333333]/20">
                        {b.bookingStatus}
                      </span>
                    </div>

                    <ul className="text-xs space-y-2 py-3 border-y border-[#E5E5E5]">
                      {b.items.map((item, idx) => (
                        <li key={idx} className="flex justify-between text-[#111111] font-semibold">
                          <span>{item.name}</span>
                          <span className="font-bold text-[#d2d0c1]">× {item.quantity}</span>
                        </li>
                      ))}
                    </ul>
                    ...
                    <div className="grid grid-cols-2 gap-2.5">
                      <button
                        ...
                        className="py-2.5 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white text-xs font-extrabold uppercase tracking-wider shadow-sm transition-all active:scale-95"
                      >
                        Preparing
                      </button>
                      <button
                        ...
                        className="py-2.5 rounded-2xl bg-[#111111] hover:bg-[#333333] text-white text-xs font-extrabold uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-sm transition-all active:scale-95"
                      >
          ...
          {activeSubTab === "activity" && (
            <div className="space-y-4">
              <h2 className="text-xl font-serif italic font-bold text-[#111111]">Recent Activity Timeline</h2>
              <div className="bg-[#F5F5F5] border border-[#E5E5E5] rounded-3xl p-5 shadow-sm space-y-3">
                {activityLogs.map((log) => (
                  <div
                    key={log.id}
                    className="p-3.5 rounded-2xl bg-white border border-[#E5E5E5] flex items-center justify-between text-xs"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <p className="font-semibold text-[#111111]">{log.message}</p>
                    </div>
                    <span className="text-[10px] font-medium text-[#737373]">{log.timestamp}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center mb-1">
            <h2 className="text-xs font-extrabold uppercase tracking-wider text-[#111111] flex items-center gap-2">
              <Activity className="size-4 text-[#d2d0c1]" />
              <span>Live Activity Stream</span>
            </h2>
          </div>

          <div className="bg-[#F5F5F5] border border-[#E5E5E5] rounded-3xl p-4 shadow-sm space-y-3 max-h-[500px] overflow-y-auto">
            {activityLogs.slice(0, 8).map((log) => (
              <div key={log.id} className="p-3 rounded-2xl bg-white border border-[#E5E5E5] space-y-1">
                <div className="flex justify-between items-center text-[10px] font-bold">
                  <span className="text-[#111111] uppercase">{log.type}</span>
                  <span className="text-[#737373]">{log.timestamp}</span>
                </div>
                <p className="text-xs font-semibold text-[#111111] leading-snug">{log.message}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 z-40 size-14 rounded-full bg-[#d2d0c1] hover:bg-[#D66A38] text-white shadow-2xl flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
      ...
      {showFoodModal && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-md flex items-center justify-center p-4">
          <div className="glass-card-premium rounded-3xl p-6 max-w-lg w-full shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto relative border-2 border-[#E5E5E5] animate-splash-in bg-[#FFFFFF]">
            <div className="flex justify-between items-center border-b border-[#E5E5E5] pb-3">
              ...
              <button
                ...
                className="text-[#737373] hover:text-[#111111] text-sm font-bold"
              >
                ✕
              </button>
            </div>
            ...
            <form onSubmit={handleFoodSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Food Item Name</label>
                <input
                  type="text"
                  required
                  value={foodForm.name}
                  ...
                  className="w-full p-3 rounded-2xl bg-[#F5F5F5] border border-[#E5E5E5] text-[#111111] text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#d2d0c1]"
                />
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Category</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Price (₹)</label>
                  <input
                    type="number"
                    required
              ...
              <div>
                <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Description</label>
                <textarea
                  rows={2}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Stock Type Badge</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-[#111111] mb-1">Initial Portions Stock</label>
                  <input
                    type="number"
              ...
              <div className="flex gap-4 pt-1">
                <label className="flex items-center gap-2 text-xs font-bold text-[#111111] cursor-pointer">
                  <input
                    ...
                    className="size-4 text-[#d2d0c1] rounded"
                  />
                  Enable Item
                </label>
              ...
              <button
                type="submit"
                className="w-full py-3.5 rounded-2xl bg-[#d2d0c1] hover:bg-[#D66A38] text-white text-sm font-extrabold shadow-md transition-colors mt-2"
              >
