...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StockDine — Live dine-in intelligence" },
      {
        name: "description",
        content:
          "See live restaurant stock, reserve tables, and hold dishes before you arrive.",
      },
      { name: "author", content: "StockDine" },
      { property: "og:title", content: "StockDine — Live dine-in intelligence" },
      {
