...
function StockDineSuperAdminPage() {
  ...
  if (!isSuperAdmin) {
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between p-4 sm:p-6 lg:p-10 relative selection:bg-[#E77B49] selection:text-white font-sans overflow-x-hidden">
        {/* Ambient Glow */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(96,36,30,0.4),transparent_70%)] pointer-events-none" />
        ...
        <header className="relative z-10 flex items-center justify-between max-w-4xl mx-auto w-full pt-2 pb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-serif italic text-2xl sm:text-3xl font-bold tracking-tight text-slate-100 block leading-none">
                StockDine OS
              </span>
        ...
        <main className="relative z-10 flex-1 flex items-center justify-center py-8">
          <div className="w-full max-w-md mx-auto">
            <div className="rounded-3xl bg-slate-900/90 backdrop-blur-2xl border border-slate-800 p-8 sm:p-10 shadow-2xl space-y-6">
              <div className="text-center space-y-2">
                ...
                <h1 className="font-serif italic text-3xl font-bold text-slate-100">
                  Super Admin Portal
                </h1>
              ...
              {loginError && (
                <div className="p-3.5 rounded-2xl bg-rose-950/60 border border-rose-800 text-rose-300 text-xs font-extrabold flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3.5 rounded-2xl bg-slate-800/80 border border-slate-700 text-xs font-bold text-slate-100 focus:outline-none focus:border-[#E77B49]"
                    />
                  </div>
                </div>
        ...
        <footer className="relative z-10 max-w-4xl mx-auto w-full pt-6 pb-2 text-center text-[11px] text-slate-500 font-medium">
  ...
  // -------------------------------------------------------------
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-[#E77B49] selection:text-white">
      {/* Top Super Admin Navigation Header */}
      <header className="sticky top-0 z-40 bg-slate-900/95 backdrop-blur-xl border-b border-slate-800 px-4 sm:px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="font-serif italic text-2xl font-bold tracking-tight text-white leading-none">
                StockDine HQ
              </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-2xl bg-rose-950/60 hover:bg-rose-900 border border-rose-800 text-rose-300 text-xs font-extrabold transition-all flex items-center gap-1.5 cursor-pointer"
          >
      ...
      <main className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 pb-20">
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="p-5 rounded-3xl bg-slate-900 border border-slate-800 shadow-lg space-y-2">
                ...
                <p className="text-[10px] text-slate-400">Real MongoDB Registered Diners & Admins</p>
              </div>
              ...
              <div className="p-5 rounded-3xl bg-slate-900 border border-slate-800 shadow-lg space-y-2">
                ...
                <p className="text-3xl font-serif italic font-bold text-emerald-400">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-4">
              ...
              {restaurantsList.filter((r) => r.status === "Pending").length === 0 ? (
                <div className="p-8 text-center bg-slate-800/40 rounded-2xl border border-slate-700 text-slate-400 text-xs font-semibold">
                    ...
                    .map((r) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-slate-400">Owner: {r.ownerName || r.email}</p>
                          <p className="text-xs text-slate-400">City: {r.city || r.address || "Local"}</p>
                        </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="relative w-full sm:w-72">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-2xl bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-100 focus:outline-none focus:border-[#E77B49]"
                />
              </div>
            </div>
                      ...
                      .map((u) => (
                        <tr key={u._id || u.id} className="hover:bg-slate-800/40">
                          <td className="p-4 font-bold text-white">
                            <div>{u.name}</div>
                            <div className="text-[10px] text-slate-400 font-mono">{u.email || "No email"}</div>
                          </td>
                          ...
                          <td className="p-4 text-right">
                            <button
                              ...
                              className="p-2 rounded-xl bg-rose-950/60 hover:bg-rose-900 border border-rose-800 text-rose-300 transition-all cursor-pointer"
                              title="Delete User"
                            >
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">{r.cuisine || "Multi-Cuisine"} • {r.city || "Local"}</p>
                    </div>
                  </div>

                  <div className="p-3 rounded-2xl bg-slate-800/60 border border-slate-700 text-xs space-y-1">
                    <div className="flex justify-between">
                      <span className="text-slate-400">Owner:</span>
                      <span className="font-bold text-white">{r.ownerName || "Partner"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Email:</span>
                      <span className="font-mono text-slate-300">{r.email}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-400">Mobile:</span>
                      <span className="font-mono text-slate-300">{r.mobileNumber || r.mobile}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    <button
                      ...
                      className="p-2.5 rounded-xl bg-slate-800 hover:bg-rose-950 border border-slate-700 hover:border-rose-800 text-slate-300 hover:text-rose-300 cursor-pointer"
            ...
            <div className="rounded-3xl bg-slate-900 border border-slate-800 overflow-hidden shadow-xl">
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs text-slate-300">
                  ...
                  <tbody className="divide-y divide-slate-800">
                    {bookingsList.map((b) => (
                      <tr key={b._id || b.id || b.bookingId} className="hover:bg-slate-800/40">
                        <td className="p-4 font-mono font-bold text-[#E77B49]">
                          {b.bookingId || b._id}
                        </td>
                        <td className="p-4 font-bold text-white">{b.restaurantName}</td>
                        <td className="p-4">{b.customerName}</td>
                        <td className="p-4 text-slate-400">{b.date}, {b.time}</td>
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-2">
                <span className="text-xs font-extrabold uppercase text-slate-400">Total Platform GMV</span>
                <p className="text-4xl font-serif italic font-bold text-emerald-400">
                  {formatCurrency(paymentsData?.gmv || stats?.gmv || 0)}
                </p>
                <p className="text-[10px] text-slate-400">Non-cancelled reservation value</p>
              </div>

              <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-2">
                <span className="text-xs font-extrabold uppercase text-slate-400">Advance Payments Collected</span>
                ...
                <p className="text-[10px] text-slate-400">Total upfront deposits processed</p>
              </div>

              <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl space-y-2">
                <span className="text-xs font-extrabold uppercase text-slate-400">Platform Commission (10%)</span>
                <p className="text-4xl font-serif italic font-bold text-blue-400">
                  {formatCurrency(((paymentsData?.gmv || stats?.gmv || 0) * 10) / 100)}
                </p>
                <p className="text-[10px] text-slate-400">Estimated net platform earnings</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === "reviews" && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            {reviewsList.length === 0 ? (
              <div className="p-8 text-center bg-slate-900 rounded-3xl border border-slate-800 text-slate-400 text-xs font-semibold">
              ...
              <div className="space-y-4">
                {reviewsList.map((rev) => (
                  <div
                    key={rev._id || rev.id}
                    className="p-5 rounded-2xl bg-slate-900 border border-slate-800 flex justify-between items-start gap-4"
                  >
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-white">{rev.userName || "Diner"}</span>
                      </div>
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-rose-950/60 hover:bg-rose-900 border border-rose-800 text-rose-300 text-xs font-bold cursor-pointer"
                    >
                      Remove Review
                    </button>
                  </div>
            ...
            <div className="space-y-4">
              {crmTickets.map((t) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-300 bg-slate-800/60 p-3 rounded-2xl border border-slate-700">
                    "{t.message}"
                  </p>
                </div>
              ))}
        ...
        {activeTab === "settings" && (
          <div className="space-y-6 max-w-2xl animate-in fade-in duration-300">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 space-y-4 text-xs font-bold">
              <div className="flex justify-between items-center py-2 border-b border-slate-800">
                <span>Default Restaurant Commission Rate</span>
              ...
              <div className="flex justify-between items-center py-2 border-b border-slate-800">
                ...
                <span className="text-emerald-400 font-mono">INR (₹)</span>
              </div>
